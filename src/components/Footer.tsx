      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="mt-16 pt-12 border-t border-gray-800 flex flex-col md:flex-row justify-between">
          <div className="space-y-4 md:space-y-0 md:space-x-12">
            <a href="/terms-of-service.html" target="_blank" rel="noopener noreferrer" className="block md:inline text-lg hover:text-white transition-colors">Terms of Service</a>
            <a href="/privacy-policy.html" target="_blank" rel="noopener noreferrer" className="block md:inline text-lg hover:text-white transition-colors">Privacy Policy</a>
          </div>
        </div>
      </div>
    </footer>
